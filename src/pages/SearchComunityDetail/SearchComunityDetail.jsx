  ...
  return (
    <>
      ...
      <div className="create-certificate-search-detail-container">
        ...
        <h3 className="search-detail-confirmation-subtitle">
          Indica la comunidad
        </h3>
        ...
        <div className="image-detail-confirmation-container">
          ...
          <div onClick={handleSelectFinalAdressClick}>
            <img src={iconoFlecha} alt="iconoFlecha" className="iconoFlecha" />
          </div>
          <h2 className="search-detail-confirmation-text">
            Carrer de Cuba, 64
          </h2>
          <h2 className="search-detail-confirmation-text-doce">12</h2>
          <h5 className="search-detail-subtitle-text">
            Presidente: Pablo Fernández
          </h5>
          <h5 className="search-detail-last-certificate-text">
            Última acta: 29/12/2023
          </h5>
          <h5 className="search-detail-first-certificate">
            Primera acta: 28/12/2003
          </h5>
